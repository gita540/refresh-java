...
class SearchTest {
  ...
  @Test
  void testTargetPresentInArray_linear_search() {
  ...
  @Test
  void testTargetNotPresentInArray_linear_search() {
    int[] nums = {1, 8, 7, 9, 67, 100};
  ...
  void testTargetPresentInArray_Binary_Search_1() {
    ...
    int act = search.binary_search(nums, 8);
    assertEquals(1, act);
  }
  ...
  void testTargetPresentInArray_Binary_Search_2() {
    int[] nums = {1, 8, 20,45,99,100};
    int act = search.binary_search(nums, 100);
    assertEquals(5, act);
  }
  @Test
  void testTargetPresentInArray_Binary_Search_3() {
    int[] nums = {1, 8, 20,45,99,100};
    int act = search.binary_search(nums, 45);
    assertEquals(3, act);
  }

  @Test
  void testTargetNotPresentInArray_Binary_Search_4() {
    int[] nums = {1, 8, 20, 45,99, 100};
    int act = search.binary_search(nums, 450);
    assertEquals(-1, act);
  }
}